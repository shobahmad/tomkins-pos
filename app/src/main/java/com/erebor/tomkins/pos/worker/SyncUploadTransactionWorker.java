...
public class SyncUploadTransactionWorker extends BaseWorker {
    ...
    public SyncUploadTransactionWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
